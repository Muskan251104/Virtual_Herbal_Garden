...
const soilTexture = textureLoader.load('TCom_Ground_SoilDusty_header.jpg');
...
const plantLoadPromises = [
    ...
    loadPlantModel('models/moringa/scene.gltf', { x: -25, y: -0.3, z: -20 }, { x: 0.05, y: 0.05, z: 0.05 }, 'Moringa'),
    loadPlantModel('models/ginger_root/scene.gltf', { x: -25, y: 0, z: 0 }, { x: 15, y: 15, z: 15 }, 'Ginger'),
    loadPlantModel('models/elderberry/scene.gltf', { x: -25, y: -1.5, z: 20 }, { x: 0.50, y: 0.50, z: 0.50 }, 'Elderberry'),
    loadPlantModel('models/chinese_milk_vetch_astragalus_sinicus/scene.gltf', { x: -25, y: -0.1, z: 40 }, { x: 70, y: 70, z: 70 }, 'Astragalus'),

    // Right side
    loadPlantModel('models/hawthorn_tree/scene.gltf', { x: 25, y: 1, z: -50 }, { x: 7, y: 7, z: 7 }, 'Hawthorn'),
    loadPlantModel('models/garlic/scene.gltf', { x: 25, y: 2, z: -20 }, { x: 3, y: 3, z: 3 }, 'Garlic'),
    loadPlantModel('models/echinacea/scene.gltf', { x: 25, y: -1.5, z: 0 }, { x: 15, y: 15, z: 15 }, 'Echinacea'),
    loadPlantModel('models/turmeric/scene.gltf', { x: 25, y: -0.015, z: 20 }, { x: 0.05, y: 0.05, z: 0.05 }, 'Turmeric'),
    loadPlantModel('models/tulsi/scene.gltf', { x: 25, y: 0, z: 40 }, { x: 7, y: 7, z: 7 }, 'Tulsi'),
];
